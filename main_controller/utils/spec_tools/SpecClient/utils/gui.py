...
class UiMixin(object):
    ...
    def set_window_position(self):
        ...
        try:
            ...
            self.setGeometry(
                rect_dict[KEY.X], rect_dict[KEY.Y],
                rect_dict[KEY.WIDTH], rect_dict[KEY.HEIGHT]
            )
    ...
    def save_window_position(self):
        ...
        print "SAVING WINDOW %s TO %s" % (key, rect_dict)
...
def dialog_error(sender = None, title=APP_NAME, msg="message"):
    ...
    if msg in ERROR_MESSAGES:
        print "dialog_error() msg " \
              "" \
              "already displayed:", msg
        return
    ...
    ERROR_MESSAGES = [m for m in ERROR_MESSAGES if msg != msg]
