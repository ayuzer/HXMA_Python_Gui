...
#dprint was broken so I commented this out... This is during inirtalization of the package
# def showstatus():

    # dprint("status of connections is:")
    ...
    # for i in connections.keys():
        # try:
           ...
           # if name.startswith('motor'):
               # continue
           # dprint("  - %s " % senders[i]().name)
        # except:
           # dprint("  - %s " % str(senders[i]()))
