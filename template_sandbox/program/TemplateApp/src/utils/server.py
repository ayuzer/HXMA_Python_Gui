...
class ServMixin(object):
    ...
    def set_server_address(self):
        ...
        try:
            ...
            serv_dict = server_settings.get(KEY.RECT)
            ...
            self.monitor.update(VAR.SERVER_ADD_STR,''.join((serv_dict[KEY.HOST],':',serv_dict[KEY.PORT])))
        except:
            pass
    def save_server_address(self):
        ...
        server_settings = self.settings.get(key, {})
        server_settings[KEY.SERV] = rect_dict
